...
public class OneSweep : MonoBehaviour
{
    ...
    private void CheckShader()
    {
        try
        {
            compute.FindKernel("GlobalHistogram");
            compute.FindKernel("FirstBinningPass");
            compute.FindKernel("SecBinningPass");
            compute.FindKernel("ThirdBinningPass");
            compute.FindKernel("FourthBinningPass");
        }
        catch
        {
