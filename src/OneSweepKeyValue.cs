...
public class OneSweepKeyValue : MonoBehaviour
{
    ...
    OneSweepKeyValue()
    {
        ...
        partitionSize = 7680;
        computeShaderString = "OneSweepKeyValue";
    }
    ...
    private void UpdatePassHistBuffer(int _size)
    {
        ...
        compute.SetBuffer(k_initStability, "b_passHist", passHistBuffer);
        compute.SetBuffer(k_initStability, "b_passTwo", passHistTwo);
        compute.SetBuffer(k_initStability, "b_passThree", passHistThree);
        compute.SetBuffer(k_initStability, "b_passFour", passHistFour);
